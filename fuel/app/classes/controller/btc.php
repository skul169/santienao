 ...
 * @extends  Controller
 */
class Controller_Btc extends Controller
{
	/**
    ...
    public function post_sell()
    {
        ...
        $view = View::forge('btc/after_sell');
