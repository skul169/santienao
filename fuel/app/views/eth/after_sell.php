                ...
                <div>
                    <div>
                        <div class="order-info-buy">
                            ...
                            <div id="qrcode" title="ethereum:0x8DC20E3AEc0346827763c10F879e681b98FF13Db?amount=0.1">
                            ...
                            <script>
                                qrCode("qrcode", "0x8DC20E3AEc0346827763c10F879e681b98FF13Db", "<?php echo $coin_number; ?>");
                            </script>

                            <p>Vui lòng chuyển đúng <b class="content_btc"><?php echo $coin_number; ?> ETH</b> vào địa chỉ</p>
                            <p>
                                <input id="wallet_to_copy" type="text" value="0x8DC20E3AEc0346827763c10F879e681b98FF13Db" size="45" style="padding: 7px 20px;">
                                <button class="btn btn-copy" data-clipboard-text="0x8DC20E3AEc0346827763c10F879e681b98FF13Db">copy</button>
                            </p>
