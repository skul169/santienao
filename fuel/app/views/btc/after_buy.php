	...
	<div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9">
                <div class="container">
                    <div class="row">
                        Vui lòng chuyển đúng <?php  echo number_format($money); ?> VND vào tài khoản 001198535465 tại ngân hàng Vietcombank
                    </div>
                    <div class="row">Sau khi nhận được tiền, chúng tôi sẽ chuyển <?php echo $coin_number; ?> bitcoin vào tài khoản của bạn</div><br>
                </div>
            </div>
        </div>
	</div>
