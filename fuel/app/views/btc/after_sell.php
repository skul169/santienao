	...
	<div class="container">
        <div class="row">
            <div class="col-xs-6 col-md-3" style="background-color: #ecf0f1;">
                ...
                <div class="row container">
                    <div class="menu-item-btn-sell-btc shepherd-target trading-menu-item">
                        <a class="list-group-item ng-scope btn-sell-btc active" href="/index.php/btc/sell">
                            <i class="fa">
            ...
            <div class="col-xs-12 col-md-9">
                <div class="container">
                    <div class="row">
                        Vui lòng chuyển đúng <?php  echo $coin_number; ?> Bitcoins vào địa chỉ
                    </div>
                    <div class="row">1EXNbPY1AEoGv3qeseXm9zSBpi5Q6rwTdL</div><br>

                    <div class="row">Sau khi chuyển bitcoin, bạn có thể kiểm tra giao dịch của bạn tại</div>
                    <div class="row">https://blockchain.info/address/1EXNbPY1AEoGv3qeseXm9zSBpi5Q6rwTdL</div>
                    <div class="row">
                        Chúng tôi sẽ thanh toán ngay khi có 1 xác nhận trong link blockchain trên. Việc xác nhận được hoàn toàn tự động bởi hệ thống Bitcoin network trên thế giới nên bạn không cần phải làm gì thêm.
                    </div>
                    <div class="row">
                        Chú ý rằng giá Bitcoin biến động liên tục. Chúng tôi sẽ chốt giá và chuyển khoản ngân hàng cho bạn ngay khi đủ 1 xác nhận (confirmation) trên bitcoin network .
                    </div>
                </div>
            </div>
        </div>
